    ...
    <form action="<?php echo e(route('admin.blog.update', $blog->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" value="<?php echo e($blog->title); ?>">
            </div>

            <div class="form-group mb-3">
                <label for="desc1">Description (1)</label>
                <input id="desc1" type="hidden" name="desc1" value="<?php echo e($blog->desc1); ?>">
                <trix-editor input="desc1"></trix-editor>
            </div>

            <div class="form-group mb-3">
                <label for="desc2">Description (2)</label>
                <input id="desc2" type="hidden" name="desc2" value="<?php echo e($blog->desc2); ?>">
            ...
            <div class="form-group">
                ...
                <img id="imagePreview1" src="<?php echo e(asset('storage/' . $blog->image1)); ?>" 
            ...
            <div class="form-group">
                ...
                <img id="imagePreview2" src="<?php echo e(asset('storage/' . $blog->image2)); ?>" 
...
<?php /**PATH C:\laragon\www\imd_dev\resources\views\admin\blog\edit.blade.php ENDPATH**/ ?>