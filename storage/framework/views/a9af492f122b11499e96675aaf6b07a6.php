...
<div class="container m-2">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="form-group">
                    ...
                    <?php if($banner->home_banner): ?>
                        <img src="<?php echo e(asset('storage/' . $banner->home_banner)); ?>" alt="home_banner" style="max-width: 200px; margin-bottom: 10px; border-radius: 5px; margin-top: 10px;">
                    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($banner->promo_banner): ?>
                        <img src="<?php echo e(asset('storage/' . $banner->promo_banner)); ?>" alt="promo_banner" style="max-width: 200px; margin-bottom: 10px; border-radius: 5px; margin-top: 10px;">
                    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($banner->card_banner): ?>
                        <img src="<?php echo e(asset('storage/' . $banner->card_banner)); ?>" alt="card_banner" style="max-width: 200px; margin-bottom: 10px; border-radius: 5px; margin-top: 10px;">
                    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($banner->wristband_banner): ?>
                        <img src="<?php echo e(asset('storage/' . $banner->wristband_banner)); ?>" alt="wristband_banner" style="max-width: 200px; margin-bottom: 10px; border-radius: 5px; margin-top: 10px;">
                    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($banner->blog_banner): ?>
                        <img src="<?php echo e(asset('storage/' . $banner->blog_banner)); ?>" alt="blog_banner" style="max-width: 200px; margin-bottom: 10px; border-radius: 5px; margin-top: 10px;">
                    <?php endif; ?>
    ...
    <center><a href="<?php echo e(route('admin.banner')); ?>" class="btn btn-success"><i class="bi bi-arrow-left"></i> Back</a></center>
</div>
...
<?php /**PATH C:\laragon\www\imd_dev\resources\views\admin\banner\edit.blade.php ENDPATH**/ ?>