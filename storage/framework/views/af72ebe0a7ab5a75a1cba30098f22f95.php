...
<div class="container m-2">
    ...
    <form action="<?php echo e(route('admin.card.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\imd_dev\resources\views\admin\card\create.blade.php ENDPATH**/ ?>