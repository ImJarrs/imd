<?php echo $__env->make('admin.template.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="<?php echo e(route('admin.wristband.create')); ?>" class="btn btn-success mt-3"> <i class="bi bi-plus-circle"></i> New</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <?php $__currentLoopData = $wristbands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('admin.wristband.edit', $item->id)); ?>" class="btn btn-warning"><i class="bi bi-pencil-square inline"></i></a>
                                                    <form action="<?php echo e(route('admin.wristband.destroy', $item->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                ...
                <?php echo $__env->make('admin.template.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\imd_dev\resources\views\admin\wristband\list.blade.php ENDPATH**/ ?>