...
<body class="bg-gradient-dark">
    ...
    <div class="container">
        ...
        <!-- Outer Row -->
        <div class="row justify-content-center mt mt-5" >
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5" >
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="align-content: center;">
                                <img src="<?php echo e(asset('assets/img/welcome.jpg')); ?>" alt="" style="width: 100%;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
    ...
    <a href="<?php echo e(route('home')); ?>" class="btn btn-warning" style="position: fixed; margin: 25px; bottom: 0;"><i class="bi bi-arrow-left"></i> Back</a>
...
</html><?php /**PATH C:\laragon\www\imd_dev\resources\views\auth\login.blade.php ENDPATH**/ ?>